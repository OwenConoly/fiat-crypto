...
Lemma App_R {descr:description} {errules : extra_rewrite_rules_opt} s m (HR : R s m) e v (H : eval_node G s e v) :
...
Lemma GetReg_R {descr:description} {errules : extra_rewrite_rules_opt} s m (HR: R s m) r i s'
...
Lemma Address_R {descr:description} {errules : extra_rewrite_rules_opt} s m (HR : R s m) (sa:AddressSize) o a s' (H : Symbolic.Address o s = Success (a, s'))
...
Lemma GetOperand_R {descr:description} {errules : extra_rewrite_rules_opt} s m (HR: R s m) (so:OperationSize) (sa:AddressSize) a i s'
...
Lemma R_SetOperand {descr:description} {errules : extra_rewrite_rules_opt} s m (HR : R s m)
...
Lemma SymexNornalInstruction_R {descr:description} {errules : extra_rewrite_rules_opt} s m (HR : R s m) instr :
...
Lemma SymexLines_R {errules : extra_rewrite_rules_opt} s m (HR : R s m) asm :
